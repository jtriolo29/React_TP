...
function DropDown({ list, parentStateSelect, setParentStateSelect }) {
  ...
  // Conditionally sets the selected value, allowing this component to hold state
  // on its own or receive it from its parent element
  const selected =
    ...
    <div className=" w-26 z-100">
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative mt-1">
          <Listbox.Button
            className="relative w-full py-2 pl-3 pr-10 text-left bg-gray-50 
          ...
          >
            <Listbox.Options
              className=" z-10 absolute w-full py-1 mt-1 overflow-auto text-base 
              bg-gray-50 rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 
