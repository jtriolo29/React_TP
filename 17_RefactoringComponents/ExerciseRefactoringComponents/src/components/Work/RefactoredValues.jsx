        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p
              ...
              text-gray-900 sm:text-4xl capitalize"
            >
              nourishing people and the planet
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              We seek out the finest natural and organic foods available,
              maintain the strictest quality standards in the industry, and have
              an unshakeable commitment to sustainable agriculture. Then, make
              these products available to every possible through our world class
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  ...
                  They partner with farmers and suppliers and carefully vet our
                  products to make sure they meet our high standards by
                  researching ingredients, reading labels and auditing sourcing
                  practices — all to make shopping easier for you.
                </dd>
              </div>
              {/* Value Two */}
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  ...
                  stakeholder. We strive to meet or exceed their expectations on
                  every shopping experience.We continually experiment and
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  ...
                  intelligence, and contributions of all of our Team Members. We
                  design and provide safe and empowering environments where
...
export default RefactoredValues;
