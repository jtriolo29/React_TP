  ...
  return (
    <>
      ...
      {error !== null ? (
        ...
        <div
          className="flex flex-col items-center my-16 mx-2 md:w-1/2 lg:w-2/5 md:mx-auto shadow-xl 
              bg-gray-50 rounded  pt-8 p-4 px-8"
        >
          <div className="flex flex-col items-center ">
            {/* Start of Head shot and Name */}
            <div
              className="flex flex-col justify-center w-64 h-64 bg-gray-300 border-gray-300 rounded-full 
                  border-2 shadow-xl text-center p-8 -m-32"
            >
              <figure>
                <img
                  className="m-auto"
              ...
              {!editing ? (
                <h1 className="text-2xl font-semibold">
                  {`${updateContactsData.firstName} ${updateContactsData.lastName}`}
                </h1>
              ) : (
            ...
            <div className="flex justify-around my-6 w-2/5 mx-auto pt-2 space-x-4">
              <button
                className="bg-blue-600 rounded-full py-4 px-8 text-white hover:bg-gray-50 
                  hover:border-blue-400  hover:text-blue-400 hover:shadow-2xl border-2"
              ...
              {/* Delete Button */}
              <button
                className="bg-red-600 rounded-full py-4 px-8 text-white hover:bg-gray-50 
                  hover:border-red-400  hover:text-red-400 hover:shadow-2xl border-2"
